...
public class InsertDMLTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("아이디를 입력하세요. _ ");
        String customId = System.console().readLine();

        System.out.print("이름를 입력하세요. _ ");
        String name = System.console().readLine();

        System.out.print("이메일를 입력하세요. _ ");
        String email = System.console().readLine();

        System.out.print("나이를 입력하세요. _ ");
        ...
        //      => 필요한 기능에 처리해야할 sql 실행메소드를 DAO(Data Access Object) 클래스에 모두 모아서 만듭니다.
