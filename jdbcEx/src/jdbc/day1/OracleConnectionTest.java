...
public class OracleConnectionTest {
    ...
    try{
        ...
        //      java 6부터 jdbc4.0 버전이 지원되고 그 때부터 생략합니다.
        //      DriverManger 가 드라이버 클래스를 알아서 로드합니다.
        Class.forName(driver);          //런타임 시점에 클래스 로드
                                        //ClassNotFountException 체크드 익셉션 -> 처리 필요
        ...
        if(conn != null){
            System.out.println("Connection 객체의 구현 클래스 : " + conn.getClass().getName());     //Connection 구현 클래스에 
                                                                    //oracle.jdbc.driver.T4CConnection 는 오라클의 Connection 구현 클래스
