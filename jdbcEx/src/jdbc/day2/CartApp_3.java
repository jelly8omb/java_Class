        ...
        while (run) {       //메뉴 선택 반복
            ...
            switch (select.toUpperCase()) {
                ...
                case "C":
                    ...
                    List<ProductVo> productlist = productDao.getProductVo(category);
                ...
                case "B":
                    ...
                    if(buyDao.buyInsert(vo)==1)
                        System.out.println("상품을 담았습니다.");
                    else        //참조테이블에 없는 값 입력했을때.
                        System.out.println("상품번호 또는 고객아이디 오류입니다.");
                    break;
                    ...
                    if(buyDao.buyDelete(buy_idx)==1)
                        System.out.println("정상적으로 취소 완료");
                    else
