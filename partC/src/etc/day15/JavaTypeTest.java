 ...
 * 1. Java.util 패키지의 Date, Calendar 클래스 : jdk 1.1 ~ .
 * 2. Java.sql 패키지의 Date, Timestamp 클래스 : jdk 1.1 ~ . 데이터베이스와 연동되는 타입
 * 3. Java.time 패키지의 LocalDate, LocalTime, LocalDateTime 클래스 : jdk 1.8 ~ .
 *                  ㄴ 날짜, 시간과 관련되 많은 클래스들과 메소드가 제공.
 */
