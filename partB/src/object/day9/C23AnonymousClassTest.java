...
public class C23AnonymousClassTest {
    public static void main(String[] args) {
        ...
        // 재정의 해야할 메서드가 1개 입니다. BeAble 인터페이스의 추상메서드가 1개 입니다.
        ...
        //람다식에서는 메서드의 인자 () 표기 -> { } 메서드 몸통에 추상 메서드 구현 부분 작성.
        BeAble beAble2 = () -> {
            
            return "무엇이든 합니다. ~~~22222";
        };
        System.out.println(beAble2.beAble());
        //자바스크립트(웹)에서는 화살표 함수로 같은 형식으로 사용됍니다.
        
    }
}
//☆☆함수형 인터페이스☆☆ 정의 y=f(x), function 키워드는 c언어, 자바스크립트에서 함수 정의에 사용
...
//      ☆자바에서 함수형 인터페이스를 익명 클래스 형식으로 많이 사용합니다. 람다식 사용 가능.☆
