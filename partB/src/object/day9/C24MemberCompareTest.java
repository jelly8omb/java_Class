...
public class C24MemberCompareTest {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(members);       //배열 요소 Member 객체가 compareTo 메소드 있으므로 정렬됩니다.
