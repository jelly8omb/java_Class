...
/*  클래스의 상속 - 자바에서 제공하는 클래스들의 상속관계를 이해하기 위함. 우리가 직접 만드는 것은 몇 가지 기능정도.
		ㄴ 자세하게(구체화된) 클래스를 만든다면 .. 삼각형,정사각형,직사각형,사다리꼴...
		ㄴ 구체화할 때 Shape 클래스를 상속받는다. 부모클래스 shape은 모든 도형들의 공통적인 필드와 메서드를 정의
...
public class Shape {    
		...
		public Shape(){
			...
			System.out.println("새로운 도형이 생겼습니다. 초기화가 필요합니다.");
		}
		...
		//day8 Object 클래스의 toString 메서드를 오버라이드
		@Override
		public String toString() {
			return "Shape [도형이름 =" + shapeName + ", 너비=" + width + ", 높이=" + height + "]"
			+ "][면적 = " + calculateArea() +"]";
		}
