...
public class B13StaticfieldExam {
    public static void main(String[] args) {
        //Wrapper 클래스들 : 기본 자료형을 클래스 타입 즉 객체로 다룰 수 있게 해준다.
        //Integer
        ...
        System.out.println("Character.SIZE = " + Character.SIZE);   //64비트
        System.out.println("Character.BYTES = " + Character.BYTES); //8바이트
...
/*
 * 위에 필드들은 모두 public static final
 * public : 모두에게 공개
 * static : 객체없이 사용할 수 있는 필드  또는 값. 정적인.. 메모리 공유 영역에 모여서 저장됌.
 * final 필드 : 값을 변경 못함.
 * (참고)final 메서드 : 오버라이딩 제한.(못함)
 * 
